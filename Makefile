...
kernel_relocated.o: kernel.o
	$(LD) $(ldopts) -o $(builddir)/kernel_relocated.o -T $(sourcedir)/linkerscripts/kernel $(builddir)/kernel.o

kernel.bin: kernel.o
	$(LD) $(ldoptsbin) $(ldopts) -o $(builddir)/kernel.bin -T $(sourcedir)/linkerscripts/kernel $(builddir)/kernel.o
